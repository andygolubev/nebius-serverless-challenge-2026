# saas-domain-tls Specification

## Purpose
Serve the SaaS site on its public domain (`sim-policy-trainer-challenge.info`) over HTTPS with
automatically issued and renewed Let's Encrypt certificates, with the whole TLS stack managed
