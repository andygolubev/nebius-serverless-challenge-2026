...
def g1_campaign(tmp_path: Path):
    return _campaign_fixture(tmp_path, "gallery-g1-survival-20260810-02")
...
def test_g1_plan_declares_both_exact_phase_evidence_prefixes(g1_campaign) -> None:
    ...
    run_id = "showcase-gallery-g1-survival-20260810-02-g1-s0"
    ...
    assert recovery["authorization"]["campaign_id"] == "gallery-g1-survival-20260810-02"
...
def test_verify_recovers_complete_g1_rough_evidence_after_provider_failure(g1_campaign) -> None:
    ...
    job_run_id = "showcase-gallery-g1-survival-20260810-02-g1-s0"
